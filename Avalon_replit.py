...
class Game(object):
    ...
    def printLeaders(self,s_players):
      
        #leaders = random.sample(self._players, self._n)
        
        print("\nTeam Leaders: " + ", ".join(s_players))
        return
...
def main():
    ...
    PLAYERS = ['nobie', 'Bethel', 'Disney', 'slam', 'Wendi', 'Ava', 'Fam', 'Kappy', 'Bri', 'Steph']
    SEED    = 6484754346
    ADDCHAR = ['Mordred', 'Morgana', 'Oberon', 'Percival']
